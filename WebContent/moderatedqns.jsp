...
<title>Moderated Questions</title>
	...
	<script src="${pageContext.request.contextPath}/resources/js/moderatedqns.js"></script>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i> Moderated Questions
                            </li>
                        </ol>
                    </div>
                </div>
