...
<title>All Questions</title>
	...
	<script src="${pageContext.request.contextPath}/resources/js/allquestions.js"></script>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i> All Questions
                            </li>
                        </ol>
                    </div>
                </div>
        						...
        						<div id="snippet-view">
                      				<!-- <div id="snippet-content">
                              			...
                              			<div class="snippet-entry">
      										<div class="vote-right home-vote">  
    											<a href="http://snippetrepo.com/snippets/no-selectable-scss-mixin/votes" class="upvote">
              									<span class="vote-btn"></span>
          										</a>
    											<span class="vote-number">1</span>
      											<a href="http://snippetrepo.com/snippets/no-selectable-scss-mixin/votes" class="downvote">
              									<span class="vote-btn"></span>
            									</a>
  											</div>
			    							...
			    							<div class="pull-left snippet-titles">			      
			      								...
			      								<h3><a href="http://snippetrepo.com/snippets/no-selectable-scss-mixin">Contents of Post P1. This is a Java post</a></h3>
			      								<div class="name"><a href="http://snippetrepo.com/users/qborreda">
			        							owner</a>
			      								</div>
			      								<p class="snippet-footer-details">Nov 29, 2014 10:47:57 PM</p>			
			  								</div>
  											<div class="clearfix"></div>  
										</div>
