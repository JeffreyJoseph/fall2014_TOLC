...
function loadRelatedQns(){
	console.log("loadRelatedQns method");
	var postId = window.localStorage.singleQn;
	var json_obj = { "post_id" : postId };
	
	if (rcvReq.readyState == 4 || rcvReq.readyState == 0) {
		rcvReq.open("POST", 'SearchForumFirst', true);
		rcvReq.setRequestHeader('Content-Type', 'application/json; charset=UTF-8');
